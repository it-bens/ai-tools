...
@test "startup wipes tracking files for current session" {
    write_tracker "sess-1" "main" '{"transcript_size":100,"files":{"/a.txt":{"ranges":[{"start":1,"end":50}],"hash":"abc123","context_tokens":1000}}}'
    write_tracker "sess-1" "agent-abc" '{"transcript_size":100,"files":{"/b.txt":{"ranges":[{"start":1,"end":null}],"hash":"def456","context_tokens":2000}}}'
...
@test "compact wipes tracking files for current session" {
    write_tracker "sess-2" "main" '{"transcript_size":500,"files":{"/c.txt":{"ranges":[{"start":1,"end":100}],"hash":"ghi789","context_tokens":5000}}}'
