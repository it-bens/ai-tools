...
| [web-fetching-with-pullmd](./plugins/web-fetching-with-pullmd/)                           | Fetch web pages, documents (PDF/Office/EPUB), and YouTube transcripts as clean Markdown via the PullMD MCP tool. A PreToolUse hook redirects WebFetch of normal pages to PullMD; the instance is set in a user- or project-level pullmd.json (project overrides user), with GitHub allowed and a per-URL escape hatch. Inspired by PullMD (by andie)                                                 | Productivity |
