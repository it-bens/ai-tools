...
| Update Claude 5 guide (Opus 5.5, Opus 5, Sonnet 5, Fable 5.1) and Claude 4 → 5 and Opus 5 → 5.5 migration | `skills/prompt-engineering/references/claude-5-guide.md` |
| Update OpenAI guide (GPT-6 Astra, Sol, Luna; GPT-5.6 Sol, Terra, Luna) and GPT-6 / GPT-5.x migration | `skills/prompt-engineering/references/openai-gpt-guide.md` |
