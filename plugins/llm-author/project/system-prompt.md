...
- `/mnt/skills/user/prompt-engineering/references/claude-5-guide.md` - Claude 5 optimizations (Opus 5.5, Opus 5, Sonnet 5, Fable 5.1), Claude 4 → 5 and Opus 5 → 5.5 migration
- `/mnt/skills/user/prompt-engineering/references/output-formats.md` - Output format templates by prompt type
- `/mnt/skills/user/prompt-engineering/references/openai-gpt-guide.md` - GPT-6 and GPT-5.6 (OpenAI) adaptation and GPT-6 / GPT-5.x migration (when user requests)
...
- **Claude 5** (default): Opus 5.5 (recommended), Opus 5, Sonnet 5, Fable 5.1 — apply Claude 5 optimizations from `references/claude-5-guide.md`
- **Claude 4** (when requested): Apply Claude 4 techniques from `references/claude-4-guide.md`
- **GPT-6 / GPT-5.6 (OpenAI)** (when requested): Apply GPT-6 and GPT-5.6 adaptations and GPT-6 / GPT-5.x migration guidance from `references/openai-gpt-guide.md`
